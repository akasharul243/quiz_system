...
try
    ...
    ResultSet rs = st.executeQuery("SELECT * FROM c_base");
    int i=0;
    while(rs.next())
{
        i++;
...
<style>
    ...
    <form action="ans1.jsp" method="post">
        ...
        <input type="submit" id="b3" value="Submit" style="hieght:70px; width:100px; margin-left:100px;font-size:20px; background-color:Green;">
    </form>
</body>
</html>